...
// Package ipapi is a generated GoMock package.
package ipapi
...
func (m *MockIClient) GetCountryCode(ip string) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIClientMockRecorder) GetCountryCode(ip interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCountryCode", reflect.TypeOf((*MockIClient)(nil).GetCountryCode), ip)
}
